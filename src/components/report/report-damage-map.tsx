...
import {
  ...
  zoneSolidColor,
  bodyTypeLabels,
} from "@/components/damage-map/silhouettes";
...
interface ReportDamageMapProps {
  items: DamageItem[];
  bodyType?: BodyType;
}

export function ReportDamageMap({ items, bodyType = "sedan" }: ReportDamageMapProps) {
  const silhouette = silhouettes[bodyType] ?? silhouettes.sedan;

  // Build lookup map: item_id → status
    ...
    <div style={{ marginBottom: "24px" }}>
      ...
      >
        ...
        >
          ...
          {/* Detail lines (windows, wheel arches, roof rails, etc.) */}
